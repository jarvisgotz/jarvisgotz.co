      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        ...
        <div className="md:hidden flex flex-col items-center pt-6 pb-5 gap-4">
          ...
          <nav className="flex items-center justify-center gap-x-3">
            <Link
              to="/"
              className="label-uppercase text-[0.92rem] tracking-[0.1em] whitespace-nowrap text-foreground/60"
              activeProps={{ className: "label-uppercase text-[0.92rem] tracking-[0.1em] whitespace-nowrap text-accent" }}
            >
              Home
            </Link>
            <Link
              to="/portraits"
              className="label-uppercase text-[0.92rem] tracking-[0.1em] whitespace-nowrap font-semibold text-foreground/70"
              activeProps={{ className: "label-uppercase text-[0.92rem] tracking-[0.1em] whitespace-nowrap font-semibold text-accent" }}
            >
              Portraits
            </Link>
            <Link
